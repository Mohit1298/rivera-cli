...
from rivera.app.utils.temporal_helpers import (
...
"""
        ...
        try:
            from rivera.app.services.summary_visualization_service import (
                ...
                for prefix in ["old", "new"]:
                    ...
                    if mem_id:
                        try:
                            ...
                            # Note: Rivera SDK documents.get returns the list under "items", not "documents" contrary to its typed response model
