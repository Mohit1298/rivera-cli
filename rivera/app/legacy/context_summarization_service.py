...
Leverages Rivera's AI answer generation to compress multiple memories
...
from rivera.app.constants import ScopeType
...
class ContextSummarizationService:
    ...
    def summarize_scope_context(
        ...
        try:
            ...
            # Step 3: Generate AI summary using Rivera
            from rivera.app.constants import ScopeType
            from rivera.app.core import create_memory_scope
...
Provide a clear, organized summary that an AI agent could use to understand the context."""
            ...
            # Use Rivera's answer.generate for summarization
