...
using Rivera's AI capabilities.
"""

from fastapi import APIRouter, Depends
from rivera.app.services.context_summarization_service import (
...
async def summarize_scope_context(
    ...
    This endpoint uses Rivera's AI to generate a concise summary of
