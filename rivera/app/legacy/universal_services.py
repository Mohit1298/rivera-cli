...
from rivera.app.clients.moorcheh import get_async_moorcheh_client, get_moorcheh_client
...
from rivera.app.core import MemoryRecord, create_memory_scope
from rivera.app.models.universal_endpoints import (
    ExportedMemory,
...
from rivera.app.utils.logging import get_logger
...
class MemorySupersedeService:
    ...
    async def _mark_memory_superseded(
        ...
        # Implementation depends on Rivera SDK capabilities
