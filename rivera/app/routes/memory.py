...
from rivera.app.routes.auth_deps import get_current_session, get_session_service
...
from rivera.app.utils.errors import AuthorizationError, map_error_to_http_exception
from rivera.app.utils.validation import CostGuard
...
async def remember(
    ...
    try:
        ...
        from rivera.app.constants import MemoryType, ProvenanceType
