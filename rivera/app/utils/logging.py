"""
Structured Logging for RIVERA Observability
"""
...
class RiveraLogger:
    """Structured JSON logger for RIVERA"""
    ...
    def log_moorcheh_call(
        ...
        """Log Rivera SDK calls"""
        log_entry = {
            "timestamp": datetime.utcnow().isoformat(),
            "level": "INFO" if success else "ERROR",
            "logger": "rivera.moorcheh",
            "request_id": request_id,
            "method": method,
            "success": success,
            "latency_ms": round(latency_ms, 2),
...
def track_moorcheh_call(method_name: str):
    """Decorator to track Rivera SDK calls"""
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                RiveraLogger.log_moorcheh_call(
                    request_id=request_id,
                    method=method_name,
                    success=success,
