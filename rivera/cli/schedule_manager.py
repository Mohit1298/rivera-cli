...
class ScheduleManager:
    """Manages OS-level scheduled tasks for RIVERA."""

    TASK_NAME = "RiveraNightlyJob"
    LEGACY_TASK_NAMES = ("RiveraDailySummary",)
