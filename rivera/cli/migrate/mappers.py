...
naturally onto Rivera's schema (id, created_at, tags) goes into the right
...
# Mem0 ships category labels per memory. Map the common ones to Rivera's
...
def map_mem0(export: dict[str, Any]) -> list[dict[str, Any]]:
    """Map a Mem0 export to rich Rivera memory payloads."""
...
def map_letta(export: dict[str, Any]) -> list[dict[str, Any]]:
    """Map Letta archival passages to rich Rivera memory payloads."""
    rows: list[dict[str, Any]] = []
    migrated_at = _now_utc()
...
def map_supermemory(export: dict[str, Any]) -> list[dict[str, Any]]:
    """Map a Supermemory export to rich Rivera memory payloads.
