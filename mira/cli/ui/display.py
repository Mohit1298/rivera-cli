"""
MIRA CLI - Welcome Banner Display
...
# ASCII art logo — clean block Mira
LOGO = r"""
          ███╗   ███╗ ███████╗ ███╗   ███╗  █████╗  ███╗   ██╗ ████████╗  ██████╗
 ▐▛██▜▌   ████╗ ████║ ██╔════╝ ████╗ ████║ ██╔══██╗ ████╗  ██║ ╚══██╔══╝ ██╔═══██╗
 ▌ ◈◈ ▐   ██╔████╔██║ █████╗   ██╔████╔██║ ███████║ ██╔██╗ ██║    ██║    ██║   ██║
...
def print_logo() -> None:
    """Print the MIRA ASCII logo and tagline."""
    console = Console()
    console.print()
...
def show_welcome_banner(config_manager: ConfigManager) -> None:
    """Render the full MIRA welcome banner to the console."""
    console = Console()
    ...
    sys_line = Text()
    sys_line.append(f"  v{MIRA_VERSION}", style=BOLD_BRIGHT)
    ...
    commands = [
        ("mira agent create <agent_name_or_id>", "Create a new mira agent"),
        ('mira remember "..."', "Store a memory"),
        ('mira recall "..."', "Search memories"),
        ('mira answer "..."', "Ask a question (RAG)"),
        ("mira connect list", "See agent integrations"),
        ("mira connect <agent>", "Connect to an AI agent"),
        ("mira ui", "Open the web dashboard UI"),
        ("mira status", "Full dashboard"),
        ("mira serve", "Start local REST API server"),
    ]
    ...
    # Footer
    console.print(
        f"  Run [{BOLD_PRIMARY}]mira --help[/{BOLD_PRIMARY}] for all commands\n",
        style="dim",
    )
