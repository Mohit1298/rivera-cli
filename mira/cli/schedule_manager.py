...
class ScheduleManager:
    """Manages OS-level scheduled tasks for MIRA."""

    TASK_NAME = "MiraNightlyJob"
    LEGACY_TASK_NAMES = ("MiraDailySummary",)
