...
naturally onto Mira's schema (id, created_at, tags) goes into the right
...
# Mem0 ships category labels per memory. Map the common ones to Mira's
...
def map_mem0(export: dict[str, Any]) -> list[dict[str, Any]]:
    """Map a Mem0 export to rich Mira memory payloads."""
...
def map_letta(export: dict[str, Any]) -> list[dict[str, Any]]:
    """Map Letta archival passages to rich Mira memory payloads."""
    rows: list[dict[str, Any]] = []
    migrated_at = _now_utc()
...
def map_supermemory(export: dict[str, Any]) -> list[dict[str, Any]]:
    """Map a Supermemory export to rich Mira memory payloads.
