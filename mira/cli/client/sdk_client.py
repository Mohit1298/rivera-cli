...
Uses the official moorcheh_sdk to interact with Rivera API.
"""
...
class SdkClient:
    ...
    def batch_remember(
        ...
        for i, item in enumerate(memories):
            ...
            # Optional per-item overrides — used by `mira migrate` to keep
    ...
    def sync_memory_to_project(
        ...
        """
        # Run export function first (ensures ~/.mira/exports/... is fresh)
