...
class ValidationError(MiraError):
    """Memory validation error"""

    pass


class MemoryError(MiraError):
    """Memory operation error"""

    pass


class NamespaceError(MiraError):
    """Namespace operation error"""

    pass


class AuthenticationError(MiraError):
    """Authentication error"""

    pass


class AuthorizationError(MiraError):
    """Authorization error"""

    pass


class SessionError(MiraError):
