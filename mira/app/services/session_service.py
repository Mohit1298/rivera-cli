...
from mira.app.config import get_data_dir, settings
...
from mira.app.utils.ids import generate_id
from mira.app.utils.temporal_helpers import utc_now
...
def get_session_service() -> "SessionService":
    ...
    if _session_service is None:
        _session_service = SessionService(secret_key=settings.MIRA_SECRET_KEY)
...
class SessionService:
    ...
    def __init__(self, secret_key: str | None = None, sessions_dir: Path | None = None):
        ...
        Args:
            ...
            sessions_dir: Directory for session storage (defaults to ~/.mira/sessions/)
        """
        resolved_secret_key = (
            secret_key
            or os.getenv("MIRA_SECRET_KEY")
            or "mira-default-secret-change-in-production"
        )
