...
from mira.app.utils.ids import generate_memory_id
...
class MemoryWriteService:
    ...
    def update_memory(
        ...
        try:
            ...
            # The namespace (mira_agent_{agent_id}) is authoritative for the
            ...
            if not agent_id and namespace.startswith("mira_agent_"):
                agent_id = namespace.removeprefix("mira_agent_")
            if not agent_id:
                raise MemoryError(
