...
from mira.app.clients.backend import get_active_llm_model
from mira.app.config import settings
from mira.app.core import agent_namespace
from mira.app.utils.errors import MemoryError
...
class MemoryReadService:
    ...
    def namespace_service(self):
        if self._namespace_service is None:
            from mira.app.services.namespace_service import NamespaceService
