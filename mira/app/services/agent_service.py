...
from mira.app.models.session import AgentCreate, AgentInfo, AgentList
...
class AgentService:
    ...
    def __init__(self, agents_dir: Path | None = None):
        ...
        Args:
            agents_dir: Directory for agent metadata storage (defaults to ~/.mira/agents/)
        """
