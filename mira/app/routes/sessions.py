...
from mira.app.clients import moorcheh as moorcheh_clients
from mira.app.config import settings
from mira.app.models.session import (
    AgentCreate,
    AgentInfo,
    AgentList,
    Session,
...
from mira.app.routes import memory  # noqa: E402
from mira.app.routes.auth_deps import (  # noqa: E402
    get_current_session,
...
async def create_agent(
    ...
    """
    Create a new MIRA agent

    Creates:
    - Agent metadata in ~/.mira/agents/
    - Rivera namespace: mira_agent_{agent_id}
