...
def main():
    ...
    if not os.getenv("RIVERA_API_KEY"):
        print("❌ Error: RIVERA_API_KEY environment variable is missing.")
        print("Please set it: export RIVERA_API_KEY='your_key'")
        sys.exit(1)
    ...
    session2_input = (
        "Hi again! What is my name and what kind of UI theme should you build for me?"
    )
