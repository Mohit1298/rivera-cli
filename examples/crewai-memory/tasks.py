"""
Task definitions for the CrewAI + Rivera integration example.
"""
...
def create_research_task(agent: Agent, topic: str = "AI agent frameworks") -> Task:
    ...
    return Task(
        description=(
            ...
            "For each key finding, use the rivera_remember tool to store it with:\n"
            ...
            "After storing all findings, use rivera_recall to verify they were saved "
            "by searching for them."
        ),
        expected_output=(
            "A confirmation that all research findings have been stored in Rivera, "
...
def create_writing_task(agent: Agent, topic: str = "AI agent frameworks") -> Task:
    ...
    return Task(
        description=(
            ...
            "Steps:\n"
            "1. Use rivera_recall with query 'market research findings' to retrieve "
            "all stored research (set limit to 10)\n"
            "2. Use rivera_recall with specific queries like 'market size', "
            "'key players', 'growth trends' to find targeted information\n"
            "3. Use rivera_answer to synthesize insights: "
